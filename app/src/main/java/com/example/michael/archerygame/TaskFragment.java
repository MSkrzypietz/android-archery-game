...
public class TaskFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                setTaskImage();
                if (isTeamATurn) Toast.makeText(GameActivity.getGameContext(), getNextPlayerTeamA(), Toast.LENGTH_SHORT);
                else Toast.makeText(GameActivity.getGameContext(), getNextPlayerTeamB(), Toast.LENGTH_SHORT);
    ...
    private void setTeamNames() {
        Cursor cursor = GameActivity.getGameContext().getContentResolver().query(ContentUris.withAppendedId(GameEntry.CONTENT_URI, gameId), null, null, null, null);
    ...
    private void initListTeam(int teamValue) {
        ...
        Cursor cursor = GameActivity.getGameContext().getContentResolver().query(PlayerEntry.CONTENT_URI, projection, selection, selectionArgs, PlayerEntry._ID);
    ...
    public void setTaskImage() {
        ...
        switch (currentTask) {
            case 1 : {
                ...
                taskText.setText("kurze Scheibe: 3 Versuche");
                break;
            }
            case 2 : case 3 : {
                imgView.setImageResource(R.drawable.ratte);
                taskText.setText("Ratte treffen: 2 Versuche");
                break;
            }
            case 4 : case 5 : case 6 : {
                imgView.setImageResource(R.drawable.duell);
                taskText.setText("lange Scheibe: 2 Versuche");
                break;
            }
            case 7 : case 8 : {
                imgView.setImageResource(R.drawable.wasserballon);
                taskText.setText("Mit Ansage: 2 Versuche");
                break;
            }
            case 9 : case 10 : {
